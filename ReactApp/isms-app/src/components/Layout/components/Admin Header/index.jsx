      ...
      <div className={cx('ml-auto flex justify-center items-center mr-4')}>
        <Tippy
          ...
          render={(attrs) => (
            <div
              ...
              {...attrs}
            >
              <h1 className="w-full h-[10%] text-[1.25rem] text-[#172b4d] font-medium ">Settings</h1>
              <div className="my-[0.75rem]">
                <h2 className="text-[0.85rem] text-[#172b4d]">QuickService Settings</h2>
                <TippyItem
                  name="Setting Name"
              ...
              <div>
                <h2 className="text-[0.85rem] text-[#172b4d] ">Personal Settings</h2>
                <TippyItem
                  name="Setting Name"
                  description="This is Description for setting"
                  icon={HiOutlineDesktopComputer}
        ...
        >
          <div
            ...
            ref={settingRef}
          >
            <AiFillSetting className="w-full h-full text-[#fff]" onClick={handleToggle} />
          </div>
        </Tippy>
