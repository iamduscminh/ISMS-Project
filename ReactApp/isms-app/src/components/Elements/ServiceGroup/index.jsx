      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex text-[#42526E]">
          <IconTag
            ...
            name="AiFillDelete"
          />
          {!detailService ? <SlArrowUp onClick={(e)=>setDetailService(true)} className="ml-[1rem] cursor-pointer" /> :<SlArrowDown onClick={(e)=>setDetailService(false)} className="ml-[1rem] cursor-pointer" />}
        </div>
      </div>
        ...
        {!isAddRequestType ? (
          ...
          >
            <div className="relative">
              ...
              />
              <IconTag onClickHandle={(e)=>setIsAddRequestType(false)} className="absolute right-0 top-[50%] cursor-pointer" name="AiOutlineClose"/>
            </div>
          </Tippy>
        )}
      </div>}
