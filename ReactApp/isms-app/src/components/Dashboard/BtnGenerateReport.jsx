  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger className="focus:outline-none">
        <div className="text-sm xl:text-lg w-[150px] py-2 bg-[#4AA976] rounded-md focus:outline-none border-0 font-semibold">
          <span className="text-sm xl:text-lg w-[150px] py-2 bg-[#4AA976] text-white focus:outline-none border-0 font-semibold">
            Export Data
          </span>
          {/* <svg
